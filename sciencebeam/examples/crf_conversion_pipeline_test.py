...
import sciencebeam.examples.crf_conversion_pipeline as conversion_pipeline
from sciencebeam.examples.crf_conversion_pipeline import (
  configure_pipeline,
  parse_args
)


BASE_TEST_PATH = '.temp/test/crf-conversion-pipeline'
